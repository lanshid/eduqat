...
const EditLessonMaterialModal = ({
  ...
  const [sessionData, setSessionData] = useState<Material>({
    id: "",
    title: "",
    type: "",
      ...
      >
        ...
        <div className="relative w-full max-w-4xl max-h-full mt-[4em] mx-auto">
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="p-3 space-y-5 pt-5">
                    ...
                    <div className="flex">
                      ...
                      <div className="w-full md:w-1/2 px-3">
                        ...
                        <input
                          ...
                          type="date"
                          value={sessionData.dateMaterial}
                          onChange={(e) => {
                            setSessionData({
                              ...sessionData,
                              dateMaterial: e.target.value,
                            });
                          }}
                        />
                      </div>
                    ...
                    <div className="flex">
                      <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input
                          ...
                          type="time"
                          placeholder="Material Title"
                          value={sessionData.timeMaterial}
                          onChange={(e) => {
                            setSessionData({
                              ...sessionData,
                              timeMaterial: e.target.value,
                            });
                          }}
                        />
                        ...
                        <div className="md:items-center mb-6">
                          <label className="md:w-2/3 text-gray-500 font-bold flex items-center">
                            <input
                              ...
                              type="checkbox"
                              checked={sessionData.isRequired}
                              onChange={(e) => {
                                setSessionData({
                                  ...sessionData,
                        ...
                        <div className="md:items-center mb-6 ml-3">
                          <label className="md:w-2/3 text-gray-500 font-bold flex items-center">
                            <input
                              className="mr-2 leading-tight"
                              type="checkbox"
                              checked={sessionData.isPreviewable}
                              onChange={(e) => {
                                setSessionData({
                                  ...sessionData,
                                  isPreviewable: e.target.checked,
                                });
                              }}
                            />
                        ...
                        <div className="md:items-center mb-6 ml-3">
                          <label className="md:w-2/3 text-gray-500 font-bold flex items-center">
                            <input
                              className="mr-2 leading-tight"
                              type="checkbox"
                              checked={sessionData.isDownloadable}
                              onChange={(e) => {
                                setSessionData({
                                  ...sessionData,
...
export default EditLessonMaterialModal;
